'''
    Experimenting with different models for classification problem 
'''
...
torch.save(model.state_dict(), f"D:\\Effi-Net-Classi\\Experimentations\\checkpoints\\{model_name}.pt")
